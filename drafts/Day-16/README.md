...
MAX7219 is a driver IC for 8x8 LED matrices or 7-segment displays. Communicates via SPI and can cascade multiple modules.
...
- Drives: 8x8 LED matrix or 8 digits 7-segment
- Cascadable: multiple modules in series
...
## 🏋️ Challenge
1. Display a basic pattern (smile face)
2. Scrolling text on the matrix
