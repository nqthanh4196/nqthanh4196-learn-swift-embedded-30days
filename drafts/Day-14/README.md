# Day 14 - I2C: Reading Temperature Sensor (BMP280)

## 📖 Introduction

Applying I2C to communicate with the BMP280 — a popular temperature and pressure sensor. Learn how to read registers and process calibration data.
...
- BMP280 measures temperature + pressure via I2C
- Calibration data must be read for accurate calculations
- 20-bit raw data requires a compensation formula
- Altitude can be calculated from pressure data

---

## 🏋️ Challenge

1. Read chip ID to confirm BMP280
2. Read and display temperature every second
3. Calculate altitude from pressure data
