...
SSD1306 is a driver chip for 0.96" OLED displays (128x64 pixels). Communicates via I2C, displays text, graphics, and charts.
...
- Divided into 8 pages (each page 8 pixels tall)
...
1. Display "Hello Pico!" on the OLED
2. Display temperature read from BMP280
3. Draw a real-time temperature graph
