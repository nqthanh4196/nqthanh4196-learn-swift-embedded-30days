# Day 19 - Flash Storage: Saving Data

## 📖 Introduction

The RP2040 has 2MB of onboard flash. Besides storing firmware, the remaining space can be used to save data, settings, and data logs.
...
- Read: directly via XIP (Execute-In-Place)
...
## 🏋️ Challenge
1. Save and read back a struct from flash
2. Data logger: record temperature every minute
3. Persist user configuration across resets
